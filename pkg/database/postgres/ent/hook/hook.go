...
// The ProductKeluarFunc type is an adapter to allow the use of ordinary
// function as ProductKeluar mutator.
type ProductKeluarFunc func(context.Context, *ent.ProductKeluarMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProductKeluarFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProductKeluarMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProductKeluarMutation", m)
}

// The ProductMasukFunc type is an adapter to allow the use of ordinary
// function as ProductMasuk mutator.
type ProductMasukFunc func(context.Context, *ent.ProductMasukMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ProductMasukFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ProductMasukMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ProductMasukMutation", m)
}
