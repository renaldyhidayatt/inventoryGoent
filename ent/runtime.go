...
func init() {
	...
	customerDescUpdatedAt := customerFields[5].Descriptor()
	...
	productkeluarDescCreatedAt := productkeluarFields[2].Descriptor()
	...
	productkeluarDescUpdatedAt := productkeluarFields[3].Descriptor()
	...
	productmasukDescCreatedAt := productmasukFields[3].Descriptor()
	...
	productmasukDescUpdatedAt := productmasukFields[4].Descriptor()
	...
	supplierDescCreatedAt := supplierFields[4].Descriptor()
	...
	supplierDescUpdatedAt := supplierFields[5].Descriptor()
